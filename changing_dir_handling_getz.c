...
/**
 * cd_dot - Change the current working directory to the home directory.
 *
...
/**
 * cd_previous - Change the current working directory to the previous directory.
 *
 * @datash: Pointer to the data structure.
 *
 * Return:
...
/**
 * cd_to_home - Change the current working directory to the home directory.
 *
 * @datash: Pointer to the data structure.
 *
 * Return:
