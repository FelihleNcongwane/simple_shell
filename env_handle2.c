...
/**
 * copy_info - Copy the information from one variable to another.
 *
 * @name:  Name of the variable to copy from.
 * @value: Value of the variable to copy to.
 *
 * Return:
...
/**
 * _unsetenv - Unset the value of an environment variable.
 *
 * @datash: Pointer to the data structure.
 *
 * Return:
